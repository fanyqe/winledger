...
public sealed class ScheduledTaskReportExporter
{
    public string ExportJson(ScheduledTaskComparison comparison, ScheduledTaskRollbackPlan? rollbackPlan = null)
    {
        var report = new ScheduledTaskReport(
            ...
            comparison.Changes,
            rollbackPlan?.Operations ?? Array.Empty<ScheduledTaskRollbackOperation>(),
    ...
    public string ExportHtml(ScheduledTaskComparison comparison, ScheduledTaskRollbackPlan? rollbackPlan = null)
    {
        ...
        <head>
          <meta charset="utf-8">
          <title>WinLedger Scheduled Tasks Report</title>
          <style>
    ...
    public string ExportText(ScheduledTaskComparison comparison, ScheduledTaskRollbackPlan? rollbackPlan = null)
    {
        return PlainTextReportFormatter.Format(
            "WinLedger Scheduled Tasks Report",
            comparison.ComparedAt,
    ...
    private sealed record ScheduledTaskReport(
        ...
        IReadOnlyList<ScheduledTaskRollbackOperation> RollbackPlan,
