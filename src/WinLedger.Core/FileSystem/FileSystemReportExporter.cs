...
public sealed class FileSystemReportExporter
{
    public string ExportJson(FileSystemComparison comparison, FileSystemRollbackPlan? rollbackPlan = null)
    {
        var report = new FileSystemReport(
            "1.0",
            ...
            comparison.Changes,
            rollbackPlan?.Operations ?? Array.Empty<FileSystemRollbackOperation>(),
    ...
    public string ExportHtml(FileSystemComparison comparison, FileSystemRollbackPlan? rollbackPlan = null)
    {
        ...
        <head>
          <meta charset="utf-8">
          <title>WinLedger File-System Report</title>
          <style>
    ...
    public string ExportText(FileSystemComparison comparison, FileSystemRollbackPlan? rollbackPlan = null)
    {
        return PlainTextReportFormatter.Format(
            "WinLedger File-System Report",
            comparison.ComparedAt,
    ...
    private sealed record FileSystemReport(
        ...
        IReadOnlyList<FileSystemRollbackOperation> RollbackPlan,
