...
public sealed class StartupReportExporter
{
    public string ExportJson(StartupComparison comparison, StartupRollbackPlan? rollbackPlan = null)
    {
        var report = new StartupReport(
            ...
            comparison.Changes,
            rollbackPlan?.Operations ?? Array.Empty<StartupRollbackOperation>(),
    ...
    public string ExportHtml(StartupComparison comparison, StartupRollbackPlan? rollbackPlan = null)
    {
        ...
        <head>
          <meta charset="utf-8">
          <title>WinLedger Startup Report</title>
          <style>
    ...
    public string ExportText(StartupComparison comparison, StartupRollbackPlan? rollbackPlan = null)
    {
        return PlainTextReportFormatter.Format(
            "WinLedger Startup Report",
            comparison.ComparedAt,
    ...
    private sealed record StartupReport(
        ...
        IReadOnlyList<StartupRollbackOperation> RollbackPlan,
