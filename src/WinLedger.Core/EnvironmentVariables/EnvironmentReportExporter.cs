...
public sealed class EnvironmentReportExporter
{
    public string ExportJson(EnvironmentComparison comparison, EnvironmentRollbackPlan? rollbackPlan = null)
    {
        var report = new EnvironmentReport(
            ...
            comparison.Changes,
            rollbackPlan?.Operations ?? Array.Empty<EnvironmentRollbackOperation>(),
    ...
    public string ExportHtml(EnvironmentComparison comparison, EnvironmentRollbackPlan? rollbackPlan = null)
    {
        ...
        <head>
          <meta charset="utf-8">
          <title>WinLedger Environment Report</title>
          <style>
    ...
    public string ExportText(EnvironmentComparison comparison, EnvironmentRollbackPlan? rollbackPlan = null)
    {
        return PlainTextReportFormatter.Format(
            "WinLedger Environment Report",
            comparison.ComparedAt,
    ...
    private sealed record EnvironmentReport(
        ...
        IReadOnlyList<EnvironmentRollbackOperation> RollbackPlan,
